...
#define I2C_FREQ              (10000000) /* 10 MHz -- clock frequency driving the i2c core: 10 MHz in this example (ADAPT TO YOUR DESIGN) */
#define TRDB_D5M_I2C_ADDRESS  (0xba)

#define TRDB_D5M_0_I2C_0_BASE (0x0000)   /* take i2c base address from system.h (ADAPT TO YOUR DESIGN) */
