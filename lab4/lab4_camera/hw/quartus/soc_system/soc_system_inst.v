	soc_system u0 (
		.cameracontroller_0_camera_conduit_framevalid (<connected-to-cameracontroller_0_camera_conduit_framevalid>), // cameracontroller_0_camera_conduit.framevalid
		.cameracontroller_0_camera_conduit_linevalid  (<connected-to-cameracontroller_0_camera_conduit_linevalid>),  //                                  .linevalid
		.cameracontroller_0_camera_conduit_clk        (<connected-to-cameracontroller_0_camera_conduit_clk>),        //                                  .clk
		.cameracontroller_0_camera_conduit_data       (<connected-to-cameracontroller_0_camera_conduit_data>),       //                                  .data
		...
		.lcd_controller_0_lcd_output_csx              (<connected-to-lcd_controller_0_lcd_output_csx>),              //       lcd_controller_0_lcd_output.csx
		.lcd_controller_0_lcd_output_d                (<connected-to-lcd_controller_0_lcd_output_d>),                //                                  .d
		.lcd_controller_0_lcd_output_dcx              (<connected-to-lcd_controller_0_lcd_output_dcx>),              //                                  .dcx
		.lcd_controller_0_lcd_output_lcd_on           (<connected-to-lcd_controller_0_lcd_output_lcd_on>),           //                                  .lcd_on
		.lcd_controller_0_lcd_output_rdx              (<connected-to-lcd_controller_0_lcd_output_rdx>),              //                                  .rdx
		.lcd_controller_0_lcd_output_resx             (<connected-to-lcd_controller_0_lcd_output_resx>),             //                                  .resx
		.lcd_controller_0_lcd_output_wrx              (<connected-to-lcd_controller_0_lcd_output_wrx>)               //                                  .wrx
	);
